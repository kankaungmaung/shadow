...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/kankaungmaung/shadow/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/kankaungmaung/shadow/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/kankaungmaung/izin/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/kankaungmaung/izin/main/ip | grep $MYIP | awk '{print $3}')
